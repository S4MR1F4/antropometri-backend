...
<head>
    ...
    <title>Kebijakan Privasi - Antropometri Indonesia</title>
...
<body>
    <div class="container">
        ...
        <p>Data dikumpulkan semata-mata untuk:</p>
        <ul>
        ...
        <p>Anda memiliki hak untuk meminta penghapusan data pribadi Anda. Anda dapat mengajukan permintaan penghapusan
            akun atau data kesehatan melalui:</p>
        <ul>
            <li><strong>Permintaan Email</strong>: Kirimkan email ke <a
    ...
    <div class="footer">
        &copy; 2026 Antropometri Indonesia. Semua Hak Dilindungi.
    </div>
</body>
